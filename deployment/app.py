...
def app():
    ...
    if choice == 'About':
        ...
        st.markdown(
            "Built with Streamlit by [ДАНГ ВАН ТХЫК КРБО-03-19](https://www.linkedin.com/in/thuc-dang-611074248). The web appplication allows to add user to database and verfify them later. Also, we provide solutions for face recognition using MTCNN and FACENET")
